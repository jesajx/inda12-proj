...
public class TableVersionHandler {
	...
	public static UpgradeResult upgradeDBTables(DataSource dataSource, String tableGroupName, DBScriptProvider scriptProvider) throws TableUpgradeException, SQLException {
		...
		return upgradeDBTables(dataSource, tableGroupName, scriptProvider, null);
	}

	public static UpgradeResult upgradeDBTables(DataSource dataSource, String tableGroupName, DBScriptProvider scriptProvider, Integer maxVersion) throws TableUpgradeException, SQLException {
		...
		try {
			...
			Integer initialVersion = getTableGroupVersion(transactionHandler, tableGroupName);
